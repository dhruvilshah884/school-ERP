...
export class LeaveService {
  public async getLeavesByClassId(classId: string): Promise<any> {
    return await models.Leave.find({ class_id: classId }).populate('requested_by student_id approved_by rejected_by class_id school')
  }
  ...
  public async deleteLeave(id: string): Promise<any> {
    return await models.Leave.findByIdAndDelete(id)
  }
